...
export const editorDict: Record<SiteLang, EditorDict> = {
  ko: {
    ...
    hintManualBg: '글자를 정확히 인식하지 못해 수동 보정이 필요해요.', hintComposite: 'AI가 정리한 이미지 위에 번역을 합성해요.', hintDrag: '텍스트를 끌어서 옮기고, 모서리와 위 핸들로 다듬어보세요',
    tabTranslate: '번역', tabFont: '폰트', tabStyle: '스타일',
    ocrEditTitle: '인식 문구 수정', ocrNeedCheck: '· 확인 필요', ocrEditHint: '문구 또는 감지 영역을 확인한 뒤 저장하면 이 이미지 하나만 다시 번역·정리합니다.', ocrResave: '인식 문구 저장 후 재처리',
    ...
    eraseOriginal: '원문 지우기', eraseHintManual: '글자를 정확히 인식하지 못했어요. 가릴 영역을 직접 보정해주세요.', eraseHintAuto: '자동 정리 결과가 어색할 때만 직접 보정해주세요.',
    eraseTransparent: '투명 처리', eraseSolid: '배경색 채우기', bgColor: '배경색', cornerRound: '모서리 둥글기',
    posX: '가로 위치', posY: '세로 위치', sizeX: '가로 크기', sizeY: '세로 크기', exportTitle: '내보내기', download: '다운로드',
  },
  en: {
    ...
    hintManualBg: "We couldn't clearly recognize the text, so manual touch-up is needed.", hintComposite: 'Translation is composited on the cleaned image.', hintDrag: 'Drag the text to move it; use the corner and top handles to adjust.',
    tabTranslate: 'Translate', tabFont: 'Font', tabStyle: 'Style',
    ocrEditTitle: 'Edit detected text', ocrNeedCheck: '· needs review', ocrEditHint: 'Check the text or detected area, then save to re-run just this image.', ocrResave: 'Save & reprocess',
    ...
    eraseOriginal: 'Erase original', eraseHintManual: "We couldn't confidently detect the text. Please adjust the area to cover.", eraseHintAuto: 'Only touch up if the auto result looks off.',
    eraseTransparent: 'Transparent', eraseSolid: 'Fill with color', bgColor: 'Fill color', cornerRound: 'Corner radius',
    posX: 'X position', posY: 'Y position', sizeX: 'Width', sizeY: 'Height', exportTitle: 'Export', download: 'Download',
  },
  ja: {
    ...
    hintManualBg: '文字を正確に認識できず、手動調整が必要です。', hintComposite: 'AIが整理した画像に翻訳を合成します。', hintDrag: 'テキストをドラッグして移動し、角と上のハンドルで調整してください。',
    tabTranslate: '翻訳', tabFont: 'フォント', tabStyle: 'スタイル',
    ocrEditTitle: '認識文言の修正', ocrNeedCheck: '· 要確認', ocrEditHint: '文言または検出領域を確認して保存すると、この画像だけ再翻訳・整理します。', ocrResave: '文言を保存して再処理',
    ...
    eraseOriginal: '原文消去', eraseHintManual: '文字を正確に認識できませんでした。隠す領域を直接調整してください。', eraseHintAuto: '自動整理の結果が不自然なときだけ調整してください。',
    eraseTransparent: '透明処理', eraseSolid: '背景色で塗る', bgColor: '背景色', cornerRound: '角の丸み',
    posX: '横位置', posY: '縦位置', sizeX: '横サイズ', sizeY: '縦サイズ', exportTitle: '書き出し', download: 'ダウンロード',
  },
  zh: {
    ...
    hintManualBg: '未能准确识别文字，需要手动修整。', hintComposite: '在 AI 整理后的图片上合成翻译。', hintDrag: '拖动文字移动，用四角和顶部手柄调整。',
    tabTranslate: '翻译', tabFont: '字体', tabStyle: '样式',
    ocrEditTitle: '修改识别文字', ocrNeedCheck: '· 需确认', ocrEditHint: '确认文字或检测区域后保存，将只对这张图片重新翻译整理。', ocrResave: '保存并重新处理',
    ...
    eraseOriginal: '擦除原文', eraseHintManual: '未能准确识别文字，请手动调整遮盖区域。', eraseHintAuto: '仅当自动清理效果不佳时再手动调整。',
    eraseTransparent: '透明处理', eraseSolid: '填充背景色', bgColor: '背景色', cornerRound: '圆角程度',
    posX: '横向位置', posY: '纵向位置', sizeX: '横向大小', sizeY: '纵向大小', exportTitle: '导出', download: '下载',
  },
}
